...
class Block(models.Model):
    type_block = models.ForeignKey('TypeBlock', models.DO_NOTHING, db_column='Type_block_id', blank=True, null=True)  # Field name made lowercase.
    player_statistic_on_set = models.ForeignKey('PlayerStatisticOnSet', models.DO_NOTHING, db_column='Player_statistic_on_set_id')  # Field name made lowercase.
...
class Match(models.Model):
    tournament = models.ForeignKey('Tournament', models.DO_NOTHING, db_column='Tournament_id')  # Field name made lowercase.
    stage = models.ForeignKey('Stage', models.DO_NOTHING, db_column='Stage_id', blank=True, null=True)  # Field name made lowercase.
    matches_place = models.ForeignKey('MatchPlace', models.DO_NOTHING, db_column='Matches_place_id')  # Field name made lowercase.
...
class Team(models.Model):
    team_type = models.ForeignKey('TypeTeam', models.DO_NOTHING, db_column='Team_type_id', blank=True, null=True)  # Field name made lowercase.
    coach = models.ForeignKey(Coach, models.DO_NOTHING, db_column='Coach_id', blank=True, null=True)  # Field name made lowercase.
...
class Player(models.Model):
    amplua = models.ForeignKey(Amplua, models.DO_NOTHING, db_column='Amplua_id', blank=True, null=True)  # Field name made lowercase.
...
class PlayerHasMistake(models.Model):
    game_mistake = models.ForeignKey(GameMistake, models.DO_NOTHING, db_column='Game_mistake_id')  # Field name made lowercase.
    player_statistic_on_set = models.ForeignKey('PlayerStatisticOnSet', models.DO_NOTHING, db_column='Player_statistic_on_set_id')  # Field name made lowercase.
    time = models.DateTimeField(auto_now_add=True)
...
class Receiving(models.Model):
    type_receiving = models.ForeignKey('TypeReceiving', models.DO_NOTHING, db_column='Type_receiving_id', blank=True, null=True)  # Field name made lowercase.
    player_statistic_on_set = models.ForeignKey(PlayerStatisticOnSet, models.DO_NOTHING, db_column='Player_statistic_on_set_id')  # Field name made lowercase.
...
class Service(models.Model):
    type_service = models.ForeignKey('TypeService', models.DO_NOTHING, db_column='Type_service_id', blank=True, null=True)  # Field name made lowercase.
    player_statistic_on_set = models.ForeignKey(PlayerStatisticOnSet, models.DO_NOTHING, db_column='Player_statistic_on_set_id')  # Field name made lowercase.
...
class Spike(models.Model):
    type_spike = models.ForeignKey('TypeSpike', models.DO_NOTHING, db_column='Type_spike_id', blank=True, null=True)  # Field name made lowercase.
    player_statistic_on_set = models.ForeignKey(PlayerStatisticOnSet, models.DO_NOTHING, db_column='Player_statistic_on_set_id')  # Field name made lowercase.
...
class TeamOnTournament(models.Model):
    tournament = models.ForeignKey('Tournament', models.DO_NOTHING, db_column='Tournament_id')  # Field name made lowercase.
    team = models.ForeignKey(Team, models.DO_NOTHING, db_column='Team_id')  # Field name made lowercase.
    league = models.ForeignKey(League, models.DO_NOTHING, db_column='League_id', blank=True, null=True)  # Field name made lowercase.
    subgroup = models.ForeignKey(Subgroup, models.DO_NOTHING, db_column='Subgroup_id', blank=True, null=True)  # Field name made lowercase.
...
class UserHasMedia(models.Model):
    media = models.OneToOneField(Media, models.DO_NOTHING, db_column='Media_id', primary_key=True)  # Field name made lowercase.
    user = models.ForeignKey(User, models.DO_NOTHING, db_column='User_id')  # Field name made lowercase.
